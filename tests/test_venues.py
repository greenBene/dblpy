...
class VenuesTestCase(unittest.TestCase):
    def test_creating_venue(self):
        venue = Venue(
            name='Electronic Information, the Visual Arts' +
            ' and Beyond Conference (EVA)',
            acronym='EVA',
        ...
        self.assertEqual(
            venue.name,
            'Electronic Information, the Visual Arts and ' +
            'Beyond Conference (EVA)')
    ...
    def test_print_venue(self):
        venue = Venue(
            name='Electronic Information, the Visual Arts and ' +
                 'Beyond Conference (EVA)',
            acronym='EVA',
            type='Conference or Workshop',
            url='https://dblp.org/db/conf/evaconf/'
        ...
        self.assertEqual(
            str(venue),
            'Electronic Information, the Visual' +
            ' Arts and Beyond Conference (EVA)' +
            ' (https://dblp.org/db/conf/evaconf/)')
    ...
    def test_get_venues(self):
        DblpAPI.load_hits = Mock(
            return_value=[{
                ...
                {"info": {
                    "venue": "Electronic Information, " +
                             "the Visual Arts and Beyond Conference (EVA)",
                    "acronym": "EVA",
                    "type": "Conference or Workshop",
                    "url": "https://dblp.org/db/conf/evaconf/"}}])
        ...
        self.assertEqual(
            venues[1].name,
            'Electronic Information, the Visual Arts ' +
            'and Beyond Conference (EVA)')
