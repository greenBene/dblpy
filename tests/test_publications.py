...
class PublicationsTestCase(unittest.TestCase):
    def test_create_publication(self):
        publication = Publication(
            authors=[
                {
                    "@pid": "p/CHPapadimitriou",
                    "text": "Christos H. Papadimitriou"},
        ...
        self.assertEqual(
            publication.ee,
            'https://doi.org/10.1145/2322176.2322189')
        self.assertEqual(
            publication.url,
            'https://dblp.org/rec/conf/acm/PapadimitriouAK12')
    ...
    def test_print_publication(self):
        ...
        self.assertEqual(
            str(publication),
            '2012. Christos H. Papadimitriou et al.' +
            ' "An Algorithmic View of the Universe".' +
            ' (https://dblp.org/rec/conf/acm/PapadimitriouAK12)')
    ...
    def test_get_publications(self):
        DblpAPI.load_hits = Mock(
            return_value=[
                {"info": {
                    ...
                    "ee": "http://cslipublications.stanford.edu" +
                          "/site/9781575866345.shtml",
                    "url": "https://dblp.org/rec/books/daglib/0030428"}},
                {
                    "info":
                    {
                        "authors": {
                            "author":
                                {
                                    "@pid": "g/WilliamIGasarch",
                                    "text": "William I. Gasarch"}},
                        "title": "Review of - Algorithmic Barriers Falling -" +
                                 " P=NP? by Donald E. Knuth and Edgar G. " +
                                 "Daylight and The Essential Knuth by Donald" +
                                 " E. Knuth and Edgar G. Daylight.",
                        "venue": "SIGACT News",
                        "volume": "46",
                        "number": "2",
                        "pages": "21-22",
                        ...
                        "url":
                        "https://dblp.org/rec/journals/sigact/Gasarch15e"
                    }
                }])
        ...
        self.assertEqual(
            publications[0].ee,
            'http://cslipublications.stanford.edu/site/9781575866345.shtml')
        self.assertEqual(
            publications[0].url,
            'https://dblp.org/rec/books/daglib/0030428')

        self.assertEqual(publications[1].authors[0], 'William I. Gasarch')
        self.assertEqual(
            publications[1].title,
            'Review of - Algorithmic Barriers Falling - P=NP?' +
            ' by Donald E. Knuth and Edgar G. Daylight and The ' +
            'Essential Knuth by Donald E. Knuth and Edgar G. Daylight.')
        ...
        self.assertEqual(
            publications[1].ee,
            'https://doi.org/10.1145/2789149.2789155')
        self.assertEqual(
            publications[1].url,
            'https://dblp.org/rec/journals/sigact/Gasarch15e')
